...
!macro CheckAllNyanpasuProcesses
  !insertmacro CheckNyanpasuProcess "clash-xiaoy.exe" "1"
...
!macro RemoveRegs
  ...
  DeleteRegValue HKCU "Software\Microsoft\Windows\CurrentVersion\Run" "clash-xiaoy"
  DeleteRegValue HKLM "SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Run" "clash-xiaoy"
  ; cleanup custom protocol handler
  DeleteRegKey HKCU "Software\Classes\clash"
  DeleteRegKey HKCU "Software\Classes\clash-xiaoy"
  DeleteRegKey HKCR "clash"
  DeleteRegKey HKCR "clash-xiaoy"
!macroend
...
Section Uninstall
  ...
  ${If} $DeleteAppDataCheckboxState == 1
    ...
    RmDir /r "$APPDATA\clash-xiaoy"
    RmDir /r "$LOCALAPPDATA\clash-xiaoy"
  ${EndIf}
