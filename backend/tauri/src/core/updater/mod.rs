...
impl UpdaterManager {
    ...
    async fn get_latest_version_manifest(&self, mirror: &str) -> Result<ManifestVersion> {
        let url = parse_gh_url(
            mirror,
            "https://raw.githubusercontent.com/libnyanpasu/clash-nyanpasu/main/manifest/version.json",
        )?;
        log::debug!("{url}");
    ...
    pub async fn mirror_speed_test(&self) -> Result<()> {
        ...
        let path = "https://raw.githubusercontent.com/libnyanpasu/clash-nyanpasu/main/manifest/version.json";
