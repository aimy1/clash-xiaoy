 ...
 * Original file: /npm/js-base64@3.7.8/base64.mjs
 *
...
function i() {
  ...
  for (
    ...
    ((r[n] = t[n]), (e[t.charCodeAt(n)] = n))
  ;((e['-'.charCodeAt(0)] = 62), (e['_'.charCodeAt(0)] = 63))
}
function u(t, e, n) {
  for (var o, i, u = [], f = e; f < n; f += 3)
...
function f(t) {
  ...
  o || i()
  for (
    var n = t.length, f = n % 3, s = '', a = [], h = 16383, c = 0, l = n - f;
    c < l;
    c += h
  )
...
function p(t, r) {
  if (l() < r) throw new RangeError('Invalid typed array length')
  return (
    g.TYPED_ARRAY_SUPPORT
      ? ((t = new Uint8Array(r)).__proto__ = g.prototype)
      : (null === t && (t = new g(r)), (t.length = r)),
    t
  )
}
function g(t, r, e) {
  if (!(g.TYPED_ARRAY_SUPPORT || this instanceof g)) return new g(t, r, e)
  if ('number' == typeof t) {
    if ('string' == typeof r)
      throw new Error(
  ...
  return 'undefined' != typeof ArrayBuffer && r instanceof ArrayBuffer
    ...
    : 'string' == typeof r
      ...
      : (function (t, r) {
          if (b(r)) {
            var e = 0 | v(r.length)
            return (0 === (t = p(t, e)).length || r.copy(t, 0, 0, e), t)
          }
          if (r) {
            if (
              ...
              return 'number' != typeof r.length || (n = r.length) != n
                ? p(t, 0)
                : A(t, r)
            if ('Buffer' === r.type && c(r.data)) return A(t, r.data)
          }
          var n
          throw new TypeError(
...
function w(t, r) {
  if ((d(r), (t = p(t, r < 0 ? 0 : 0 | v(r))), !g.TYPED_ARRAY_SUPPORT))
...
function _(t, r, e, n, o) {
  ...
  if (('string' == typeof r && (r = g.from(r, n)), b(r)))
  ...
  return K(
    (function (t, r) {
      for (var e, n, o, i = [], u = 0; u < t.length && !((r -= 2) < 0); ++u)
        ((n = (e = t.charCodeAt(u)) >> 8), (o = e % 256), i.push(o), i.push(n))
      return i
    })(r, t.length - e),
    t,
    e,
...
function x(t, r, e) {
  ...
  return (function (t) {
    ...
    var e = '',
      n = 0
    for (; n < r; ) e += String.fromCharCode.apply(String, t.slice(n, (n += D)))
    return e
  })(n)
}
;((g.TYPED_ARRAY_SUPPORT =
  ...
  (g.compare = function (t, r) {
    if (!b(t) || !b(r)) throw new TypeError('Arguments must be Buffers')
    if (t === r) return 0
  ...
  (g.prototype.equals = function (t) {
    if (!b(t)) throw new TypeError('Argument must be a Buffer')
...
function k(t, r, e, n, o, i) {
  if (!b(t)) throw new TypeError('"buffer" argument must be a Buffer instance')
...
function V(t, r, e, n, o) {
  return (o || Z(t, 0, e, 4), a(t, r, e, n, 23, 4), e + 4)
}
function q(t, r, e, n, o) {
  return (o || Z(t, 0, e, 8), a(t, r, e, n, 52, 8), e + 8)
}
;((g.prototype.slice = function (t, r) {
  ...
  (g.prototype.readFloatLE = function (t, r) {
    return (r || N(t, 4, this.length), s(this, t, !0, 23, 4))
  }),
  (g.prototype.readFloatBE = function (t, r) {
    return (r || N(t, 4, this.length), s(this, t, !1, 23, 4))
  }),
  (g.prototype.readDoubleLE = function (t, r) {
    return (r || N(t, 8, this.length), s(this, t, !0, 52, 8))
  }),
  (g.prototype.readDoubleBE = function (t, r) {
    return (r || N(t, 8, this.length), s(this, t, !1, 52, 8))
  }),
  ...
  (g.prototype.fill = function (t, r, e, n) {
    ...
    if (
      ...
      var u = b(t) ? t : G(new g(t, n).toString()),
        f = u.length
...
function H(t) {
  return (function (t) {
    ...
    ;((a = '=' === t[c - 2] ? 2 : '=' === t[c - 1] ? 1 : 0),
      ...
      (f = a > 0 ? c - 4 : c))
    var l = 0
    for (r = 0, u = 0; r < f; r += 4, u += 3)
      ((s =
        (e[t.charCodeAt(r)] << 18) |
        (e[t.charCodeAt(r + 1)] << 12) |
        (e[t.charCodeAt(r + 2)] << 6) |
        e[t.charCodeAt(r + 3)]),
        (h[l++] = (s >> 16) & 255),
        (h[l++] = (s >> 8) & 255),
        (h[l++] = 255 & s))
    return (
      2 === a
        ? ((s = (e[t.charCodeAt(r)] << 2) | (e[t.charCodeAt(r + 1)] >> 4)),
          (h[l++] = 255 & s))
        : 1 === a &&
          ((s =
            (e[t.charCodeAt(r)] << 10) |
            (e[t.charCodeAt(r + 1)] << 4) |
            (e[t.charCodeAt(r + 2)] >> 2)),
          (h[l++] = (s >> 8) & 255),
          (h[l++] = 255 & s)),
      h
    )
...
const W = '3.7.8',
  ...
  rt = (() => {
    let t = {}
    return (tt.forEach((r, e) => (t[r] = e)), t)
  })(),
  et =
    /^(?:[A-Za-z\d+\/]{4})*?(?:[A-Za-z\d+\/]{2}(?:==)?|[A-Za-z\d+\/]{3}=?)?$/,
  nt = String.fromCharCode.bind(String),
  ot =
  ...
  st =
    'function' == typeof btoa
      ? (t) => btoa(t)
      : (t) => g.from(t, 'binary').toString('base64'),
  at = (t) => g.from(t).toString('base64'),
  ht = (t, r = !1) => (r ? it(at(t)) : at(t)),
  ct = (t) => {
    if (t.length < 2)
      return (r = t.charCodeAt(0)) < 128
        ? t
        : r < 2048
          ? nt(192 | (r >>> 6)) + nt(128 | (63 & r))
          : nt(224 | ((r >>> 12) & 15)) +
            nt(128 | ((r >>> 6) & 63)) +
            nt(128 | (63 & r))
  ...
  lt = /[\uD800-\uDBFF][\uDC00-\uDFFFF]|[^\x00-\x7F]/g,
  pt = (t) => t.replace(lt, ct),
  gt = (t) => g.from(t, 'utf8').toString('base64'),
  yt = (t, r = !1) => (r ? it(gt(t)) : gt(t)),
  dt = (t) => yt(t, !0),
  wt =
  ...
  At = (t) => {
    switch (t.length) {
      case 4:
        var r =
          (((7 & t.charCodeAt(0)) << 18) |
            ...
            (63 & t.charCodeAt(3))) -
          65536
        return nt(55296 + (r >>> 10)) + nt(56320 + (1023 & r))
      case 3:
        return nt(
      ...
      default:
        return nt(((31 & t.charCodeAt(0)) << 6) | (63 & t.charCodeAt(1)))
    }
  },
  vt = (t) => t.replace(wt, At),
  bt = (t) => {
    ...
    for (let i = 0; i < t.length; )
      ((r =
        ...
        64 === e
          ? o.push(nt((r >> 16) & 255))
          : 64 === n
            ? o.push(nt((r >> 16) & 255, (r >> 8) & 255))
            : o.push(nt((r >> 16) & 255, (r >> 8) & 255, 255 & r)))
    return o.join('')
  },
  Et =
    'function' == typeof atob
      ? (t) => atob(ut(t))
      : (t) => g.from(t, 'base64').toString('binary'),
  Rt = (t) => ot(g.from(t, 'base64')),
  mt = (t) => Rt(Ut(t)),
  _t = (t) => g.from(t, 'base64').toString('utf8'),
  Ut = (t) => ut(t.replace(/[-_]/g, (t) => ('-' == t ? '+' : '/'))),
  Pt = (t) => _t(Ut(t)),
  Tt = (t) => {
  ...
  Bt = (t) => ({ value: t, enumerable: !1, writable: !0, configurable: !0 }),
  St = function () {
    const t = (t, r) => Object.defineProperty(String.prototype, t, Bt(r))
  ...
  Ct = function () {
    const t = (t, r) => Object.defineProperty(Uint8Array.prototype, t, Bt(r))
    ;(t('toBase64', function (t) {
      return ht(this, t)
    }),
      t('toBase64URI', function () {
...
export {
  ...
  dt as encodeURI,
  dt as encodeURL,
  It as extendBuiltins,
  St as extendString,
  Ct as extendUint8Array,
  Pt as fromBase64,
  ht as fromUint8Array,
  Tt as isValid,
  yt as toBase64,
  mt as toUint8Array,
  pt as utob,
...
export default null
//# sourceMappingURL=/sm/3db30ac25b987fca2be8b6fa412380be53f1b95e945be713935a2688140cf733.map
