...
import { atomDashboardLayout, atomIsDrawer } from '@/store'
import {
  closestCenter,
  DndContext,
  DragEndEvent,
...
function Dashboard() {
  ...
  const {
    items: dataItems,
    gridLayout: dataPanelGridLayout,
    supportMemory,
  } = useDataPanelItems({ visible })
  ...
  const renderContent = (id: string) => {
    ...
    switch (id) {
      case 'info-combined':
        return (
          <CombinedInfoPanel timingData={health} refreshCount={refreshCount} />
        )
      case 'proxy-shortcuts':
