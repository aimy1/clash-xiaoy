...
const ColumnFilterDialog = lazy(() => import('@/components/connections/connections-column-filter'));
...
function Connections() {
    ...
    return (<SearchTermCtx.Provider value={throttledSearchTerm}>
      <BasePage title={t('Connections')} full header={<div className="flex max-h-96 w-full flex-1 items-center justify-end gap-2 pl-5">
            <div className="flex items-center gap-1">
              <Suspense fallback={null}>
                <ColumnFilterDialog open={openColumnFilter} onClose={() => setOpenColumnFilter(false)}/>
              </Suspense>
              <HeaderSearch value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)}/>
