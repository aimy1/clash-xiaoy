...
export const Catch = ({ error }) => {
    return (<div className={cn('h-dvh bg-black text-white', 'flex flex-col gap-4 p-4')}>
      <div className="fixed top-0 left-0 z-10 h-6 w-full" data-tauri-drag-region/>
...
const TanStackRouterDevtools = () => null; // Temporarily disabled
