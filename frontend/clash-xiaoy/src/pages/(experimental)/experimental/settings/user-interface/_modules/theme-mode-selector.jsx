import { ThemeMode, useExperimentalThemeContext, } from '@/components/providers/theme-provider';
...
export default function ThemeModeSelector() {
    ...
    return (<SettingsCard data-slot="theme-mode-selection-card">
      <SettingsCardContent className="flex items-center justify-between px-3" data-slot="theme-mode-selection-card-content">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent>
            <DropdownMenuRadioGroup value={themeMode} onValueChange={handleThemeModeChange}>
              {Object.values(ThemeMode).map((value) => (<DropdownMenuRadioItem key={value} value={value}>
                  {value}
