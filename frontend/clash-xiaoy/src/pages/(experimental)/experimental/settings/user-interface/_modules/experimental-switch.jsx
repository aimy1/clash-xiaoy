...
export default function ExperimentalSwitch() {
    ...
    return (<SettingsCard data-slot="experimental-switch-card">
      <SettingsCardContent className="flex items-center justify-between px-3" data-slot="experimental-switch-card-content">
