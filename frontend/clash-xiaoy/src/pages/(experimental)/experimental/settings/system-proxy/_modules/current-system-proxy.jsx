...
export default function CurrentSystemProxy() {
    ...
    return (<SettingsCard data-slot="current-system-proxy-card">
      <SettingsCardContent data-slot="current-system-proxy-card-content" className="flex flex-col gap-3 px-2">
        <div className="px-1">
