...
const InnerComponent = () => {
    ...
    return (<div className="relative mx-4 flex flex-col" data-slot="rules-virtual-list" style={{
      ...
      {virtualItems.map((virtualItem) => {
            ...
            return (<div key={virtualItem.key} ref={rowVirtualizer.measureElement} className={cn('absolute top-0 left-0 w-full select-text', 'font-mono break-all', 'flex items-center gap-2 py-2')} data-index={virtualItem.index} data-slot="rules-virtual-item" style={{
