...
const InnerComponent = () => {
    const { query: { data: logs }, } = useClashLogs();
    ...
    return (<div className={cn('relative mx-4 flex flex-col', 'divide-outline-variant divide-y')} data-slot="logs-virtual-list" style={{
      ...
      {virtualItems.map((virtualItem) => {
            ...
            return (<div key={virtualItem.key} ref={rowVirtualizer.measureElement} className={cn('absolute top-0 left-0 w-full select-text', 'font-mono break-all', 'flex flex-col py-2')} data-index={virtualItem.index} data-slot="logs-virtual-item" style={{
