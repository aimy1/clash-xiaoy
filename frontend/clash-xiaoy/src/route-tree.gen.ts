...
export interface FileRoutesByFullPath {
  '/': typeof IndexRoute
  '/browser': typeof legacyBrowserRoute
...
export interface FileRoutesById {
  ...
  '/(legacy)/browser': typeof legacyBrowserRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/(legacy)/browser': {
      ...
      path: '/browser'
      fullPath: '/browser'
      preLoaderRoute: typeof legacyBrowserRouteImport
      parentRoute: typeof legacyRouteRoute
    }
    '/(experimental)/experimental/settings': {
...
interface legacyRouteRouteChildren {
  legacyBrowserRoute: typeof legacyBrowserRoute
