...
export const DrawerContent = ({ className, onlyIcon, }) => {
    ...
    return (<Box className={cn('p-4 cyber-glass animate-float', getSystem() === 'macos' ? 'pt-14' : 'pt-8', 'w-full', 'h-full', 'flex', 'flex-col', 'gap-4', className)} data-tauri-drag-region>
      <div className="mx-2 flex flex-col items-center justify-center gap-2 mb-2">
        ...
        {!onlyIcon && (<div className="text-lg font-bold cyber-text-glow text-center tracking-widest uppercase font-mono" data-tauri-drag-region>
            {'clash-xiaoy'}
          </div>)}
      </div>
