...
export default function AnimatedLogo(props) {
    ...
    return (<motion.div data-slot="app-header-logo" data-tauri-drag-region role="button" tabIndex={0} onClick={triggerShake} onKeyDown={handleKeyDown} animate={logoControls} aria-label="Animate logo" {...props}>
      <LogoSvg className="logo-colorized h-full w-full" data-tauri-drag-region/>
    </motion.div>);
}
