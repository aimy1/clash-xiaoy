...
export const ServiceShortcuts = () => {
    ...
    const { query: { data: serviceStatus }, } = useSystemService();
    ...
    return (<Paper className="flex !h-full flex-col justify-between gap-2 !rounded-3xl p-3 cyber-glass">
      {serviceStatus ? (<>
          ...
          <div className="flex w-full flex-col gap-2">
            <Box className="flex w-full items-center justify-between gap-2 rounded-2xl px-3 py-2 text-sm" sx={status.sx}>
            ...
            <Box className="flex w-full items-center justify-between gap-2 rounded-2xl px-3 py-2 text-sm" sx={coreStatus.sx}>
              <div className="text-[var(--text-sub)]">
                {t('service_shortcuts.core_status')}
              </div>
              <Tooltip title={!!coreStatusSWR.data?.[1] &&
