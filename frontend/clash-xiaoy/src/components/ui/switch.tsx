...
export const Switch = ({
  ...
  return (
    <SwitchPrimitives.Root
      className={cn(
        'peer',
        'inline-flex h-8 w-14 shrink-0 cursor-pointer items-center rounded-[var(--radius-control)]',
    ...
    >
      <SwitchPrimitives.Thumb
        className={cn(
          ...
          'rounded-[var(--radius-control)] shadow-md ring-0 transition-all duration-200 ease-in-out',
