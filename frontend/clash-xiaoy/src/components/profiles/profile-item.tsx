        ...
        sx={[
          ...
          (theme) => ({
            backgroundColor: selected
              ...
              : 'transparent',
            borderColor: selected ? 'var(--primary) !important' : 'var(--border) !important',
          }),
        ]}
      >
        <div
        ...
        >
          <div className="flex items-center justify-between gap-2">
            ...
            {selected && (
              <FiberManualRecord
                className="top-0 mr-auto !size-3 animate-pulse"
                sx={(theme) => ({
        ...
        <motion.div
          className={cn(
            ...
            'rounded-[var(--radius-card)] font-bold backdrop-blur',
          )}
