...
export const QuickImport = () => {
    ...
    return (<TextField hiddenLabel fullWidth autoComplete="off" spellCheck="false" value={url} placeholder={t('Profile URL')} onChange={(e) => setUrl(e.target.value)} onKeyDown={(e) => url !== '' && e.key === 'Enter' && handleImport()} sx={{ input: { py: 1, px: 2 } }} slotProps={{
            input: inputProps,
        }}/>);
};
