...
export const TopBar = () => {
  ...
  return (
    ...
    >
      <div
        className="hidden md:flex gap-2 ml-3 group-has-[#top-bar-center_>_*]:hidden"
        data-tauri-drag-region
      >
        <div
          className="flex items-center gap-4 px-3 py-1.5 text-xs font-mono tabular-nums text-[var(--text-main)] rounded-md border border-[var(--border)] bg-[var(--bg-card)] pointer-events-none"
          data-tauri-drag-region
        >
        ...
        <div
          className="flex items-center px-3 py-1.5 text-xs font-mono tabular-nums text-[var(--text-sub)] rounded-md border border-[var(--border)] bg-[var(--bg-card)] pointer-events-none"
          data-tauri-drag-region
          aria-label={t('Time')}
        >
