...
export const TopBar = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="cyber-glass flex items-center gap-4 px-3 py-1.5 text-xs font-mono tabular-nums text-[var(--text-main)] rounded-full pointer-events-none"
          data-tauri-drag-region
        >
        ...
        <div
          className="cyber-glass flex items-center px-3 py-1.5 text-xs font-mono tabular-nums text-[var(--text-sub)] rounded-full pointer-events-none"
          data-tauri-drag-region
          aria-label={t('Time')}
        >
