...
import { CloseRounded, CropSquareRounded, FilterNoneRounded, HorizontalRuleRounded, PushPin, PushPinOutlined, } from '@mui/icons-material';
...
const CtrlButton = (props) => {
    return (<Button className="!size-7 !min-w-0 !p-0 ios-motion ios-pressable" sx={(theme) => ({
...
export const LayoutControl = ({ className }) => {
    ...
    return (<div className={cn('flex gap-2', className)} data-tauri-drag-region>
      <CtrlButton onClick={toggleAlwaysOnTop}>
        {alwaysOnTop ? (<PushPin fontSize="small" style={{ transform: 'rotate(15deg)' }}/>) : (<PushPinOutlined fontSize="small" style={{ transform: 'rotate(15deg)' }}/>)}
      </CtrlButton>
      ...
      <CtrlButton onClick={() => {
        ...
        {isMaximized ? (<FilterNoneRounded fontSize="small" style={{
