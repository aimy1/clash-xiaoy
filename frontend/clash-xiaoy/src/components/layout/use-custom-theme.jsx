...
import { alpha, darken, lighten, useColorScheme } from '@mui/material';
...
const applyRootStyleVar = (mode, theme) => {
    ...
    root.style.setProperty('--background-color-alpha', alpha(palette.primary.main, 0.1));
...
const ThemeInner = ({ children }) => {
    ...
    useEffect(() => {
        if (themeMode === 'system') {
            ...
            const chosenThemeMode = themeMode || 'light';
