...
export function AnimatedOutlet({ ref, ...props }) {
...
export function AnimatedOutletPreset(props) {
    const matches = useMatches();
    ...
    return (<AnimatePresence mode="popLayout" initial={false}>
      <AnimatedOutlet key={id} layout layoutId={id} initial="initial" animate="visible" exit="hidden" variants={{
            initial: {
                translateX: '30%',
                opacity: 0,
            },
