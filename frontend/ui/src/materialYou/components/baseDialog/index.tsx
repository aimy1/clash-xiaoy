        ...
        <Portal.Root className="fixed top-0 left-0 z-50 h-dvh w-full">
              ...
              sx={[
                (theme) => ({
                  ...theme.applyStyles('dark', {
                    backgroundColor: alpha(theme.vars.palette.common.black, 0.45),
                  }),
                }),
              ]}
          ...
          <Box
            ...
            className={cn(
              ...
              full ? 'h-dvh w-full' : 'min-w-96 rounded-[var(--radius-card)] shadow',
              mode === 'dark' ? 'text-white shadow-zinc-900' : 'text-black',
            )}
            sx={(theme) => ({
              backgroundColor: theme.vars.palette.background.default,
              border: full ? undefined : `1px solid var(--border)`,
            })}
            animate={open ? 'open' : 'closed'}
            initial={{
              opacity: 0,
          ...
          >
            <div
              className={cn(
                ...
                !full ? 'm-3' : OS === 'macos' ? 'ml-20 p-3.5' : 'm-2 ml-6',
              )}
            ...
            <div
              className={cn(
                'relative overflow-x-hidden overflow-y-auto p-3',
                full && 'h-full px-6',
              )}
              style={{
                maxHeight: full
